...
pre-dem-browser 是一款 JavaScript 端无埋点统计工具。几乎可以在 0 配置的情况下前端报错监控、Ajax 请求的记录等功能。
...
将 pre-dem-browser.js 文件引入到你需要的 html 页面中， 然后初始化 SDK.
...
- 引入 js 文件
```
    <script type="text/javascript" src="pre-dem-browser.js"></script>
```
